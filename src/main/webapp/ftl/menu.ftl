        ...
        <div class="flex flex-col lg:flex-row justify-around items-center">
            <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                <div class="flex items-start mb-6 tm-menu-item">
                    <img src="assets/img/menu-item-1.jpg" alt="Image" class="rounded-md">
                ...
                <div class="flex items-start mb-6 tm-menu-item">
                       <img src="assets/img/menu-item-2.jpg" alt="Image" class="rounded-md">
                    <div class="ml-3 sm:ml-6">
                ...
                <div class="flex items-start mb-6 tm-menu-item">
                    <img src="assets/img/menu-item-3.jpg" alt="Image" class="rounded-md">
                    <div class="ml-3 sm:ml-6">
                ...
                <div class="flex items-start mb-6 tm-menu-item">
                    <img src="assets/img/menu-item-4.jpg" alt="Image" class="rounded-md">
                    <div class="ml-3 sm:ml-6">
            ...
            <div class="flex-1 m-5 rounded-xl px-4 py-6 sm:px-8 sm:py-10 tm-bg-brown tm-item-container">
                <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                    ...
                    <img src="assets/img/menu-item-5.jpg" alt="Image" class="rounded-md">
                </div>
                <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                    <div class="text-right mr-6">
                    ...
                    <img src="assets/img/menu-item-6.jpg" alt="Image" class="rounded-md">
                </div>
                <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                    <div class="text-right mr-6">
                    ...
                    <img src="assets/img/menu-item-7.jpg" alt="Image" class="rounded-md">
                </div>
                <div class="flex items-start justify-end mb-6 tm-menu-item-2">
                    <div class="text-right mr-6">
                    ...
                    <img src="assets/img/menu-item-8.jpg" alt="Image" class="rounded-md">
                </div>
            </div>
        </div>
    </div>
